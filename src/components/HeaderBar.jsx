    ...
    <header className="sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/80 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 select-none">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-[#9FE8FA] to-[#E0F7FA] shadow-[inset_0_1px_0_rgba(255,255,255,0.6),0_8px_24px_rgba(79,143,255,0.15)] flex items-center justify-center">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl bg-[#F9FAFB] border border-slate-200 shadow-inner text-slate-500">
          ...
          <button className="relative p-2 rounded-xl bg-white shadow-sm hover:shadow transition-shadow border border-slate-200 text-slate-600">
          ...
          <button className="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm hover:shadow transition-shadow">
